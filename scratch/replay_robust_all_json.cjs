...
// Chunk 0: State variables (Using smart matching so we don't depend on non-existent WOW comment)
...
// Let's load the newly inserted tab's material studio segment to match exactly
...
applyReplace("Step 230", cleanValue(step230Args.TargetContent || step230Args.targetContent), cleanValue(step230Args.ReplacementContent || step230Args.replacementContent));
