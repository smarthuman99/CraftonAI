...
const MAT_DATA = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1531315630201-bb15abeb1653?q=80&w=400&auto=format&fit=crop"
  },
  {
    id: "MAT-03",
    category: "leather",
    ...
    image: "https://images.unsplash.com/photo-1608964205561-125fc7f123ba?q=80&w=400&auto=format&fit=crop"
  },
  {
    id: "MAT-04",
    category: "fabrics",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1598928506311-c55ded91a20c?q=80&w=400&auto=format&fit=crop"
  },
  {
    id: "MAT-06",
    category: "fabrics",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1507347901231-8e104f7ccd0d?q=80&w=400&auto=format&fit=crop"
  },
  {
    id: "MAT-10",
    category: "metal",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1618220179428-22790b461013?q=80&w=400&auto=format&fit=crop"
  },
  {
    id: "MAT-14",
    category: "stone",
...
const MaterialLibrary = ({ lang, onProceedToContact }) => {
  ...
  return (
    <div className="animate-editorial-slide-up" style={{ maxWidth: '1200px', margin: '0 auto', padding: '4rem 2rem', position: 'relative' }}>
      ...
      <div style={{ marginBottom: '5.5rem' }}>
        ...
        <div style={{ 
          ...
          {/* Card 01 */}
          <div className="material-workflow-card" style={{
      ...
      <div style={{ marginTop: '5rem', marginBottom: '8rem' }} id="explorer-section">
        <div style={{ 
          ...
          <div>
            <span style={{ fontSize: '0.72rem', color: '#7C7267', letterSpacing: '0.15em', textTransform: 'uppercase', fontFamily: 'var(--font-sans)', display: 'block', marginBottom: '0.4rem' }}>
              {lang === "Cn" ? "實時篩選" : "ONLINE BROWSER"}
            </span>
            <h3 style={{ fontFamily: 'var(--font-tech)', fontSize: '1.8rem', color: 'var(--accent-primary)', fontWeight: '400' }}>
          ...
          <div style={{ position: 'relative', width: '100%', maxWidth: '300px' }}>
            ...
            />
            <svg style={{ width: '15px', height: '14px', position: 'absolute', left: '12px', top: '11px', color: 'var(--text-muted)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          {categories.map((cat) => (
            <button
              ...
              style={{
                ...
                borderRadius: '100px',
                border: activeCategory === cat.id ? '1px solid var(--accent-primary)' : '1px solid rgba(124, 114, 103, 0.15)',
        ...
        {filteredMaterials.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '4rem', color: 'var(--text-muted)', fontFamily: 'var(--font-sans)', fontSize: '0.9rem' }}>
                ...
                >
                  ...
                  <div style={{ height: '180px', overflow: 'hidden', position: 'relative' }}>
                    ...
                    {isSelected && (
                      <div style={{
                        ...
                        <svg style={{ width: '12px', height: '12px' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3.5">
                  ...
                  <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', flex: 1, gap: '1rem' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                      <span style={{ fontSize: '0.68rem', color: 'var(--text-muted)', letterSpacing: '0.5px', textTransform: 'uppercase', fontFamily: 'var(--font-sans)', display: 'flex', alignItems: 'center', gap: '4px' }}>
                        📍 {lang === "Cn" ? mat.originCn : mat.originEn}
                      </span>
                      <h4 style={{ fontFamily: 'var(--font-tech)', fontSize: '1.25rem', color: 'var(--text-primary)', fontWeight: '400', lineHeight: '1.3' }}>
      ...
      {selectedMaterials.length > 0 && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
            ...
            <div>
              <div style={{ fontFamily: 'var(--font-tech)', fontSize: '1.1rem', color: 'var(--text-primary)', fontWeight: '500' }}>
              ...
              <div style={{ 
                ...
                {selectedMaterials.map(m => `[${m.code}] ${lang === "Cn" ? m.nameCn.split(' (')[0] : m.nameEn.split(' (')[0]}`).join(', ')}
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
            ...
            >
              ...
              <svg style={{ width: '14px', height: '14px' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.2">
