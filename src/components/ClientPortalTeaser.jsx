...
const ClientPortalTeaser = ({ lang, selectedFabric, selectedLeg, setActiveIntakeModal }) => {
  ...
  const handleMarketingPackingSim = () => {
    ...
    const mockBoxes = [
      {
        id: 1,
        name: lang === "Cn" ? "大理石餐桌 (重) [x:5 y:5 z:5]" : "Marble Table (Heavy) [x:5 y:5 z:5]",
        color: "#8B5A51",
        w: 75,
        h: 25,
        d: 35,
      ...
      {
        id: 2,
        name: lang === "Cn" ? "真皮三人沙发 [x:80 y:5 z:5]" : "Leather Sofa [x:80 y:5 z:5]",
        color: "#422F25",
        w: 60,
        h: 32,
        d: 30,
      ...
      {
        id: 3,
        name: lang === "Cn" ? "大堂扶手椅 C-01 [x:5 y:5 z:45]" : "Lobby Chair C-01 [x:5 y:5 z:45]",
        color: "#7A8775",
        w: 25,
        h: 25,
        d: 25,
      ...
      {
        id: 4,
        name: lang === "Cn" ? "大堂扶手椅 C-02 [x:35 y:5 z:45]" : "Lobby Chair C-02 [x:35 y:5 z:45]",
        color: "#7A8775",
        w: 25,
        h: 25,
        d: 25,
      ...
      {
        id: 5,
        name: lang === "Cn" ? "定制实木大茶几 [x:5 y:35 z:5]" : "Oak Coffee Table [x:5 y:35 z:5]",
        color: "#C5B4A5",
        w: 65,
        h: 22,
        d: 40,
      ...
      {
        id: 6,
        name: lang === "Cn" ? "高档电视矮柜 [x:75 y:35 z:5]" : "Lounge TV Console [x:75 y:35 z:5]",
        color: "#A97C73",
        w: 50,
        h: 26,
        d: 22,
      ...
      {
        id: 7,
        name: lang === "Cn" ? "餐椅成套包装 [x:5 y:5 z:75]" : "Dining Chairs Pack [x:5 y:5 z:75]",
        color: "#A8988C",
        w: 70,
        h: 25,
        d: 35,
  ...
  return (
    <div
      className="portal-teaser-container"
      style={{
        marginTop: "0",
        paddingTop: "0"
      }}
    >
      <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
        ...
        >
          {lang === "Cn" ? "订单跟进与客户控制台" : "ORDER TRACKING & CLIENT CONSOLE"}
        </span>
        <h2
          style={{
            fontSize: "2.2rem",
        ...
        >
          {lang === "Cn"
            ? "登录专属会员中心，随时随地掌握全局"
            : "Your order, clearly tracked from intake to delivery."}
        </h2>
        <p
          style={{
            maxWidth: "700px",
        ...
        >
          {lang === "Cn"
            ? "定制家具最让人焦虑的是交期与品质。客户可在会员中心实时查看订单状态，让生产、合规与海运进度更加透明。"
            : "Bespoke contract manufacturing should not be a black box. Your dashboard tracks tolerances, compliance checkpoints, container loading, and sea transit updates."}
        </p>
      </div>
      ...
      >
        {marketingTeaserTab === "specs" && (
          ...
          >
            <div>
              <span className="logo-badge" style={{ marginBottom: "1rem", display: "inline-block" }}>
                PORTAL PREVIEW — INTAKE
              </span>
              <h4
                style={{
                  fontFamily: "var(--font-tech)",
              ...
              >
                {lang === "Cn"
                  ? "当您将手绘草图、技术 PDF 或包含面料明细的 Excel 表格上传至会员中心时，系统会整理尺寸参数与材质清单，生成中英对照的技术 BOM。已确认的规格与物料文件将进行云端归档。"
            ...
            >
              ...
              {[
                {
                  time: "09:42:01",
                  msg: "Scanning uploaded 'Drawing_04_VIP_LobbyChair.pdf'...",
                  en: "Scanning uploaded 'Drawing_04_VIP_LobbyChair.pdf'..."
                },
                {
                  time: "09:42:03",
                  msg: "Extracted W:650mm, H:850mm, D:600mm. Matching with Crib 5...",
                  en: "Extracted W:650mm, H:850mm, D:600mm. Matching with Crib 5..."
                },
                {
                  time: "09:42:04",
                  msg: "Specification finalized. Secure signature generated.",
                  en: "Specification finalized. Secure signature generated."
                }
              ].map((log, idx) => (
                <div
                  key={idx}
        ...
        {marketingTeaserTab === "inspection" && (
          ...
          >
            <div>
              ...
              >
                {lang === "Cn"
                  ? "订单完成组装后，质检人员会将实物照片与确认图纸进行对照，检查轮廓、颜色与关键尺寸。质检结果将作为订单的出厂证明，在线随时可查。"
                  : "Once assembly is complete, production photos are checked against the approved drawings for contours, colour, and key dimensions. Each result is stored as a signed QA report in the client portal."}
              </p>
              <div
                style={{
                  fontSize: "0.75rem",
            ...
            >
              ...
              <div
                style={{ fontSize: "0.72rem", color: "var(--text-secondary)", lineHeight: "1.4", marginBottom: "12px" }}
              >
                {lang === "Cn"
                  ? "请滚动至上方，在定制工坊查看实物与图纸对照质检。"
                  : "Scroll to the interactive workshop above to view the inspection demonstration."}
              </div>
            </div>
          </div>
        )}
        ...
        {marketingTeaserTab === "packing" && (
          ...
          >
            <div>
              <span className="logo-badge" style={{ marginBottom: "1rem", display: "inline-block" }}>
                PORTAL PREVIEW — OPTIMIZED PACKING
              </span>
              <h4
                style={{
                  fontFamily: "var(--font-tech)",
              ...
              >
                {lang === "Cn"
                  ? "📦 3D 货柜物理体积堆叠排柜优化"
                  : "📦 3D Container Stacking & Cargo Protection Optimization"}
              </h4>
              <p
                style={{
                  fontSize: "0.88rem",
              ...
              >
                {lang === "Cn"
                  ? "合约家具订单通常包含大理石台面、异形沙发等笨重或怕挤压部件。系统会根据包装箱尺寸进行三维排布，坚持重货在底、轻货在顶并防止倒置，以减少运输损伤并提升装载效率。"
                  : "Contract shipments often contain heavy stone pieces and delicate upholstered furniture. The loading plan uses package dimensions to keep heavy items below lighter goods, avoid inversion, and improve container utilization."}
              </p>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
                <button
                  ...
                  style={{
                    padding: "0.5rem 1rem",
                    fontSize: "0.72rem",
                    background: marketingPackingRunning ? "var(--accent-muted)" : "var(--accent-primary)"
                  }}
                >
                  {marketingPackingRunning
                    ? lang === "Cn"
                      ? `装货中 ${marketingPackingProgress}%`
                      : `Packing ${marketingPackingProgress}%`
                    : lang === "Cn"
                      ? "▶ 运行 3D 堆叠算法"
                      : "▶ Start 3D Stacking Sim"}
                </button>
                <span style={{ fontSize: "0.72rem", fontWeight: "600", color: "var(--text-secondary)" }}>
                  {lang === "Cn"
                    ? `已装载箱数: ${marketingPackingBoxes.length} / 7`
                    : `Items Stacked: ${marketingPackingBoxes.length} / 7`}
                </span>
              </div>
            </div>
            ...
            >
              <div
                className="isometric-container-stage"
                style={{
                  position: "relative",
                  width: "180px",
                  height: "110px",
              ...
              >
                <div
                  style={{
                    ...
                    height: "100%",
                    background:
                      "linear-gradient(rgba(124,114,103,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(124,114,103,0.08) 1px, transparent 1px)",
                ...
                {marketingPackingBoxes.length > 0 && (
                  ...
                  >
                    {lang === "Cn"
                      ? `空间率: ${60 + marketingPackingBoxes.length * 5.4}%`
                      : `UTIL: ${60 + marketingPackingBoxes.length * 5.4}%`}
                  </div>
                )}
              </div>
            </div>
        ...
        {marketingTeaserTab === "shipping" && (
          ...
          >
            <div>
              <span className="logo-badge" style={{ marginBottom: "1rem", display: "inline-block" }}>
                PORTAL PREVIEW — TRANSIT TRACKER
              </span>
              <h4
                style={{
                  fontFamily: "var(--font-tech)",
            ...
            >
              <svg
                ...
                width="100%"
                height="100%"
                style={{ stroke: "#C5B4A5", strokeWidth: "1.2", fill: "none", strokeLinecap: "round" }}
              >
                <path
                  d="M 10,20 Q 40,5 60,30 T 110,15 T 160,40 T 190,10"
                  style={{ stroke: "rgba(124,114,103,0.15)", strokeWidth: "3" }}
                />
                <path
                  d="M 20,90 Q 50,110 80,85 T 130,100 T 180,80"
                  style={{ stroke: "rgba(124,114,103,0.15)", strokeWidth: "3" }}
                />
                <path
                  d="M 20,40 Q 60,65 110,50 T 180,25"
                  style={{ stroke: "var(--accent-muted)", strokeWidth: "1", strokeDasharray: "3,3" }}
                />
                ...
                <circle
                  ...
                  cy="45"
                  r="5"
                  style={{ fill: "var(--accent-green)", stroke: "#FAF9F6", strokeWidth: "1.5" }}
                />
                <circle
                  cx="120"
                  cy="45"
                  r="9"
                  style={{ fill: "none", stroke: "var(--accent-green)", strokeWidth: "0.8", opacity: 0.6 }}
                ...
                <text
                  x="110"
                  y="60"
                  style={{ fill: "var(--accent-green)", fontSize: "5px", fontFamily: "monospace", fontWeight: "bold" }}
                >
                  TUSCAN_BREEZE_v12
                </text>
              </svg>
